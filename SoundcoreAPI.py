import socket
import threading
from bluetooth import BluetoothSocket, find_service
...
class Soundcore:
    def __init__(self, macaddress: str, onEvent=None):
        ...
        if len(self.service):
            self.Port = find_service(address=self.macaddress)[0]["port"]
        else:
        ...
        self.data = ""
        self.bluesock = BluetoothSocket(proto=3)
